...
# operating system:  Linux 6.1.0-38-686-pae i686 [ELF] (6.1.0)
# libc:	(6.36.0)
# binutils:	(240)
...
SUBDIRS=common_d 	cdda_d 	libdi_d 	cddb_d 	cdinfo_d 	labelh_d 	xmcd_d 	cda_d 	util_d
...
install::
	@BINDIR=$(BINDIR) LIBDIR=$(LIBDIR) MANDIR=$(MANDIR) 		MANSUFFIX=$(MANSUFFIX) $(SHELL) ./install.sh -n
