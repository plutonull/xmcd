 ...
 *   application to the SCO UNIX operating system.  The name "SCO"
...
#ifndef lint
static char *_os_sco_h_ident_ = "@(#)os_sco.h	6.27 04/01/14";
#endif
...
#define SCO_MAX_XFER	(32 * 1024)	/* Max per-request data length */
...
#endif	/* _SCO_SVR3 DI_SCSIPT CDDA_RD_SCSIPT DEMO_ONLY */
