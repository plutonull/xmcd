 ...
 */
#ifndef lint
static char *_os_dgux_c_ident_ = "@(#)os_dgux.c	6.46 04/03/02";
#endif
...
)
{
	...
	param_blk.flags.data_write = (rw == OP_DATAOUT);
        ...
        if (ioctl(devp->fd, USER_SCSI_CMD, &param_blk) < 0) {
...
pthru_vers(void)
{
	return ("OS module for Data General DG/UX");
}
