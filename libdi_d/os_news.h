...
#ifndef lint
static char *_os_news_h_ident_ = "@(#)os_news.h	6.24 04/01/14";
#endif
...
#define NEWS_MAX_XFER	(16 * 1024)	/* Max per-request data length */
...
#endif	/* sony_news DI_SCSIPT CDDA_RD_SCSIPT DEMO_ONLY */
