 ...
 */
#ifndef lint
static char *_os_sinix_c_ident_ = "@(#)os_sinix.c	6.48 04/03/02";
#endif
...
)
{
	...
	if (ioctl(devp->fd, IOSSCSICMD, &req) < 0) {
...
pthru_vers(void)
{
	return ("OS module for Siemens Pyramid Reliant UNIX");
}
